...
- 轻触点亮：黑屏时碰一下屏幕就以低亮度亮起 20 秒，摸黑回家不必再去按墙上的实体开关
- 每五分钟轻微移动画面，降低 OLED 烧屏风险
- 带简短 CRT 风格提示音的就寝提醒
- 白天按设定间隔提醒起身活动的久坐提醒
- 在本地局域网控制 Yeelight 吸顶灯（开关及学习、休息两个预设），并通过 Wake-on-LAN 唤醒电脑
- 从私人 VPS 状态桥读取 HostVDS 与三毛机场的剩余流量
- 在已 root 的手机上支持开机恢复和任务移除恢复
...
- 长按：打开时钟设置
- 黑屏时轻触：点亮 20 秒，其间再碰一下就重新计满，各种滑动手势照常可用
...
架构、环境光阈值、常驻方案、安装、验证、流量桥配置和故障排查统一记录在
